...
const AgreePage = () => {
    ...
    return (
        ...
        <PageWrap id="content">
            ...
            {/* 이용약관 */}
            <AgreeContentWrap className="notoRegular" style={agreePageKind == 'serviceDetail' ? { display: 'block' } : { display: 'none' }}>
                서비스 이용 약관<br />
                <br />
            사용자 여러분 안녕하세요.<br />
            ...
            {/* 개인정보 이용약관 */}
            <AgreeContentWrap className="notoRegular" style={agreePageKind == 'personDetail' ? { display: 'block' } : { display: 'none' }}>
                [팀모두]('모두 - 나의 구독 서비스 관리'이하 '모두')은(는) 「개인정보 보호법」 제30조에 따라 정부주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.<br />
                ○ 이 개인정보처리방침은 2021년 6월 28부터 적용됩니다.<br />
                <br />
                제1조(개인정보의 처리 목적)<br />
                <br />
                [팀모두]('모두 - 나의 구독 서비스 관리'이하 '모두')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 겨우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br />
                1. 홈페이지 회원가입 및 관리<br />
                회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지 목적으로 개인정보를 처리합니다.<br />
                <br />
                2. 재화 또는 서비스 제공<br />
                서비스 제공, 콘텐츠 제공, 맞춤서비스 제공을 목적으로 개인정보를 처리합니다.<br />
                <br />
                3. 마케팅 및 광고에의 활용<br />
                ...
                <br />
                ① [팀모두]은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.<br />
                <br />
                ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.<br />
                1.[홈페이지 회원가입 및 관리]<br />
                [홈페이지 회원가입 및 관리]와 관련한 개인정보는 수집.이용에 관한 동의일로부터[3년]까지 위 이용목적을 위하여 보유.이용됩니다.<br />
                보유근거 : 회원가입 시 필수 유저 정보, 앱 사용 기록 보유<br />
                <br />
                2.[홈페이지 회원가입 및 관리]<br />
                [홈페이지 회원가입 및 관리]와 관련한 개인정보는 수집.이용에 관한 동의일로부터[6개월]까지 위 이용목적을 위하여 보유.이용됩니다.<br />
                ...
                제3조(개인정보의 제3자 제공)<br />
                <br />
                ① [팀모두]은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br />
                ② [팀모두]은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.<br />
                1. [현재 해당 사항 없음]<br />
                개인정보를 제공받는 자 : 현재 해당 사항 없음<br />
                ...
                제4조(개인정보처리 위탁)<br />
                <br />
                ① [팀모두]은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.<br />
                1. [현재 해당사항없음]<br />
                위탁받는 자 (수탁자) :<br />
                위탁하는 업무의 내용 :<br />
                위탁기간 :<br />
                ② [팀모두]은(는) 위탁계약 체결시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.<br />
                ...
                <br />
                <br />
                ① 정보주체는 팀모두에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.<br />
                ② 제1항에 따른 권리 행사는팀모두에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 팀모두은(는) 이에 대해 지체 없이 조치하겠습니다.<br />
                ...
                ⑥ 팀모두은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.<br />
                <br />
                <br />
                제6조(처리하는 개인정보의 항목 작성)<br />
                <br />
                ① [팀모두]은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br />
                1[ 홈페이지 회원가입 및 관리 ]<br />
                필수항목 : 휴대전화번호, 성별, 이름, 연령대<br />
                선택항목 :<br />
                <br />
                <br />
                제7조(개인정보의 파기)<br />
                <br />
                ① [팀모두] 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.<br />
                <br />
                ...
                1. 파기절차<br />
                [팀모두] 은(는) 파기 사유가 발생한 개인정보를 선정하고, [팀모두] 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.<br />
                2. 파기방법<br />
                ...
                <br />
                [팀모두]은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.<br />
                1. 정기적인 자체 감사 실시<br />
                ...
                <br />
                <br />
                팀모두 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용하지 않습니다.<br />
                제10조 (개인정보 보호책임자)<br />
                ① 팀모두 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br />
                ▶ 개인정보 보호책임자<br />
                성명 :신민재<br />
                직책 :대표<br />
                직급 :CEO<br />
                연락처 :010-4027-0880, smj7162@naver.com,<br />
                ※ 개인정보 보호 담당부서로 연결됩니다.<br />
                ▶ 개인정보 보호 담당부서<br />
                부서명 :<br />
                담당자 :<br />
                연락처 :, ,<br />
                ② 정보주체께서는 팀모두 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 팀모두 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br />
                제11조(개인정보 열람청구)<br />
                정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.<br />
                [팀모두]은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.<br />
                ...
                - 2019. 11. 27 ~ 2021. 06. 27 적용 (<a href="https://codeforeveryone.tistory.com/entry/%EC%95%88%EB%93%9C%EB%A1%9C%EC%9D%B4%EB%93%9C-%EB%AA%A8%EB%91%90-%EA%B0%9C%EC%9D%B8%EC%A0%95%EB%B3%B4-%EC%B2%98%EB%A6%AC%EB%B0%A9%EC%B9%A8?category=821240" target="_blank">클릭</a>)<br />

...
import { DetailRowWrap, DetailItemWrap, DetailItemTitle, DetailItemContent, DetailButton } from '../../styled/main';
            ...
            <Fade collapse when={openStatus} duration={500}>
                <ContentDetailWrap>
                    ...
                    <DetailRowWrap>
                        ...
                        <DetailItemWrap>
                            <DetailItemTitle>마지막 결제일</DetailItemTitle>
                            <DetailItemContent>없음 </DetailItemContent>
                        </DetailItemWrap>
                    </DetailRowWrap>
                    ...
                    <DetailRowWrap>
                        ...
                        <DetailItemWrap>
                            <DetailItemTitle>파티여부</DetailItemTitle>
                            <DetailItemContent>없음 </DetailItemContent>
                        </DetailItemWrap>
                    </DetailRowWrap>
